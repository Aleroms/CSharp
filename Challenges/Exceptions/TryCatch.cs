...
In the exercise, you will find the DivideNumbers method, which for now, simply divides two integers. 
...
When the b argument is zero, the result returned from this method is zero. 
Also, "Division by zero." is printed to the console.

No matter if b is zero or not, after the calculation has been performed, 
this method should also print "The DivideNumbers method ends."
